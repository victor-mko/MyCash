...
class Form extends Component {
    ...
    render() {
        return ( <
            ...
            onClick = { this.props.handleCloseOpenForm } >
            <
            ...
            <
            i className = "" > < /i> <
            select value = { this.state.invoice.type }
            onChange = { this.handleTypeChange }
            className = "typeInvoice" >
            <
            ...
            i className = "" > < /i> <
            a href = ""
            className = "dateInvoice" > { day + "/" + month + "/" + year } < /a> < /
            div > <
            div className = "for-what-invoice imput-box" >
            <
            i className = "" > < /i> <
            select value = { this.state.invoice.expensesType }
            ...
            <
            i className = "" > < /i> <
            input placeholder = "Enter the spent sum"
